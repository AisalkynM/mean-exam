...
/* harmony default export */ __webpack_exports__["default"] = ("<!-- \n<button [routerLink]=\"['']\" routerLinkActive=\"router-link-active\">Home</button>\n<button [routerLink]=\"['/products']\" routerLinkActive=\"router-link-active\">Product List</button>\n<button [routerLink]=\"['/product/new']\" routerLinkActive=\"router-link-active\">Product Creation</button>\n-->\n\n\n<router-outlet></router-outlet> ");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>Update Product</p>\n<div *ngFor=\"let err of errors\">\n    <p style=\"color:rgb(150, 13, 192);\">{{err}}</p>\n</div>\n\n<form *ngIf=\"editProduct\" (submit)=\"updateProduct()\">\n    Name:<input type=\"text\" name=\"editProduct.name\" [(ngModel)]=\"editProduct.name\"><br>\n    Qty:<input type=\"text\" name=\"editProduct.qty\" [(ngModel)]=\"editProduct.qty\"><br>\n    Price:<input type=\"text\" name=\"editProduct.price\" [(ngModel)]=\"editProduct.price\"><br>\n\n    <div *ngIf=\"editProduct.name.length>=3\">\n        <input type=\"submit\" value=\"UPDATE\"><br>\n    </div>\n</form>\n\n\n<button [routerLink]=\"['/']\" routerLinkActive=\"router-link-active\">RESET</button>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h1>Product List</h1>\n<button [routerLink]=\"['/products/new']\" routerLinkActive=\"router-link-active\">Add New Product</button>\n\n<table>\n    <thead>\n        <tr>\n            <th>ID</th>\n            <th>Name</th>\n            <th>Qty</th>\n            <th>Price</th>\n            <th>Actions</th>\n        </tr>\n    </thead>\n    <tbody>\n        <tr *ngFor=\"let product of allProducts\">\n            <td>{{product._id}}</td>\n            <td>{{product.name}}</td>\n            <td>{{product.qty}}</td>\n            <td>${{product.price}}</td>\n            <td>\n                <button [routerLink]=\"['/products', product._id,'edit']\" routerLinkActive=\"router-link-active\">Edit</button>\n                <button [routerLink]=\"['/products', product._id]\" routerLinkActive=\"router-link-active\">Details</button>\n                <button (click)=\"destroyOneProduct(product._id)\" >Delete</button>\n            </td>\n        </tr>\n    </tbody>\n</table>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>New Product</p>\n<div  *ngFor=\"let err of errors\">\n    <p style=\"color:rgb(150, 13, 192);\">{{err}}</p>\n</div>\n\n<form (submit)=\"createProduct()\">\n    Name:<input type=\"text\" name=\"newProduct.name\" [(ngModel)]=\"newProduct.name\"><br>\n    Qty:<input type=\"text\" name=\"newProduct.qty\" [(ngModel)]=\"newProduct.qty\"><br>\n    Price:<input type=\"text\" name=\"newProduct.price\" [(ngModel)]=\"newProduct.price\"><br>\n    <!-- <div *ngIf=\"(newProduct.name.length>2)\"> -->\n    <div *ngIf=\"(newProduct.name.length>2) && (newProduct.qty>=0) && (newProduct.price>=0)\">\n        <input type=\"submit\" value=\"CREATE\"><br>\n    </div>\n    \n</form>\n<button [routerLink]=\"['/']\" routerLinkActive=\"router-link-active\">RESET</button>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>Product Details!</p>\n<h3>Name:</h3>\n<p>{{oneProduct.name}}</p>\n<h3>Qty:</h3>\n<p>{{oneProduct.qty}}</p>\n<h3>Price:</h3>\n<p>{{oneProduct.price}}</p>\n\n<div *ngIf=\"oneProduct.qty == 0\">\n    <button (click)=\"destroyOneProduct(oneProduct._id)\" >DELETE</button>\n</div>\n\n<button [routerLink]=\"['/']\" routerLinkActive=\"router-link-active\">BACK</button>");
...
module.exports = __webpack_require__(/*! /Users/coding/Desktop/mean_stack/angular/MEAN/public/src/main.ts */"./src/main.ts");
